...
from sample_data import process_csv, convert_to_place_list

# 讀取資料
df = process_csv("sample_data.csv")
TEST_LOCATIONS = convert_to_place_list(df)
